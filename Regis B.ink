...
Hearing Rebecca come onto the PA system again, Giorgio looks over his notes of the different crew members preparing to choose the team that will explore the surface.
	...
	Giorgio: As you all know, I’ll be sending out a few of you to do the research we need! The people I don’t choose will stay on the ship and do any research that they can! Just like last time, I will be staying on the ship myself to continue my own work.
...
(If Lars already chosen) Lars and Iris reach out to one another and hold hands.
...
(If Iris already chosen) Lars and Iris reach out to one another and hold hands.
...
Walk the shoreline
Enter the inland forest
(Only if Willy was chosen) Venture out on the coastline, return in the forest
...
Lars: It is nice just getting to walk the shore and take in the sights. It’s different from anything I’ve done before, that’s for sure.
	...
	The two hold hands as they walk across the coastline. (Third crew member) feels out of place, as though they’re the third wheel on a date.
...
(If following the choice 3 path)~~~~~~
	Finishing up collecting data they need on the shoreline, the researchers decide to venture deeper inland to the forest covering the island. (Proceed to the Choice 2 path).
...
(If Iris and Lars chosen)~~
	...
	Iris: Yea, I’m alright I think! As I’m sure you’ve learned, I’m used to tripping over 
and falling.

	Lars and Iris laugh together as Lars helps Iris stand up. The two of them continue on ahead, Lars holding Iris up and leading the way, leaving (3rd crew member) trailing behind.
...
Rebecca starts up the ship’s PA system and broadcasts a message to the entire crew.
	...
	C: Great work crew! We’re headed off to the last planet for our expedition! I’ve decided to finish Regis B. It seems similar to our atmosphere so I figured it’d be a nice place to remind us of home!!
...
Hearing Rebecca come onto the PA system again, Giorgio looks over his notes of the different crew members preparing to choose the team that will explore the surface for the last time.
	...
	Giorgio: I’m sure you all know exactly what I’m gonna say, but I’ll be sending out three of you to do the final research we need! The people I don’t choose will stay on the ship and finish up all the research that they can! I think I’ll be heading out and helping with the field work this time around!
...
(If Lars already chosen) Lars and Iris link arms and cuddle up to one another.
...
(If Iris already chosen) Lars and Iris link arms and cuddle up to one another.
...
After the third choice:
		(If Iris is not chosen) Iris looks down sadly, but accepts that this mission isn’t for her.
...
Enter the inland forest
(Only if Willy was chosen) Venture out on the coastline, return in the forest
(Only is Lars, Iris, and Willy are chosen) Scout the land for Colonization
